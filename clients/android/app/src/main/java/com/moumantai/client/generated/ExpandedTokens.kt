...
package com.moumantai.client.generated

object ExpandedTokens {
    // Typography (sp)
    ...
    const val BUTTON_PADDING_X = 24
    const val CHIP_HEIGHT = 32
    const val CHIP_PADDING_X = 16
    const val FAB_SIZE = 56
    const val FAB_EXTENDED_HEIGHT = 56
    const val INPUT_HEIGHT = 56
    const val INPUT_PADDING_X = 16
    const val DIALOG_PADDING = 24
    const val ICON_SIZE_SMALL = 18
    const val ICON_SIZE = 24
    const val ICON_SIZE_LARGE = 32
    const val LIST_ITEM_HEIGHT = 56
    const val TOPBAR_HEIGHT = 56
