...
/**
 * Resolve a path against the data model: "/" → root, "$." → item-scope field
 * (prefix stripped), bare key → item-scope lookup.
 */
...
/** Navigate a JSON Pointer (RFC 6901) through nested maps and lists, or null if not found. */
